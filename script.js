...
const getWeather=async (city)=>
{
    try{
        ...
        const response= await fetch(`https://api.openweathermap.org/data/2.5/weather?q=${city}&appid=9a0947dcf9e8b956884fabaa0fbe65b7`,
...
if(navigator.geolocation)
{
    ...
    const proxy="https://cors-anywhere.herokuapp.com/";
        ...
        const api=`${proxy}api.openweathermap.org/data/2.5/weather?lat=${lat}&lon=${long}&appid=9a0947dcf9e8b956884fabaa0fbe65b7`
